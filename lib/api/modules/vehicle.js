 ...
 */
export async function createVehicle({ registration_number, plate_number, make, model, colour, state_id }) {
  return apiFetch("/vehicles", {
    method: "POST",
    body: { registration_number, plate_number, make, model, colour, state_id },
  });
}
