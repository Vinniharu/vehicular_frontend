 ...
 * the Driver's Licence card instead of hardcoding one.
 */
export async function getDriverLicenceFeeSchedule() {
  return apiFetch("/applications/driver-licence/fee-schedule", { method: "GET" });
}
