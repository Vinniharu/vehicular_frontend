 ...
 */
export async function submitVehicleParticularsApplication({ vehicle_id, items, delivery_address }) {
  return apiFetch("/applications/vehicle-particulars", {
    method: "POST",
    body: { vehicle_id, items, delivery_address },
  });
}
 ...
 */
export async function submitCentralMotorRegistryApplication({ vehicle_id, state_id, nin, applicant_email, vehicle_licence, delivery_address }) {
  return apiFetch("/applications/central-motor-registry", {
    method: "POST",
    body: { vehicle_id, state_id, nin, applicant_email, vehicle_licence, delivery_address },
  });
}
...
export async function submitRoadworthinessApplication({
  vehicle_id, bay_id, slot_template_id, booking_date, papers, prior_application_id, delivery_address,
}) {
  return apiFetch("/applications/roadworthiness-express", {
    method: "POST",
    body: { vehicle_id, bay_id, slot_template_id, booking_date, papers, prior_application_id, delivery_address },
  });
}
...
export async function submitVehicleVerificationApplication({
  ...
  chassis_number, customs_duty_certificate, delivery_address,
}) {
  return apiFetch("/applications/vehicle-verification", {
    method: "POST",
    body: { state_id, check_type, plate_number, make, model, year, colour, reason, chassis_number, customs_duty_certificate, delivery_address },
  });
}
...
export async function submitPhysicalConditionInspectionApplication({
  ...
  preferred_date, preferred_time, reason, supporting_document, delivery_address,
}) {
