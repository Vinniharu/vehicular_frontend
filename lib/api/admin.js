 ...
 * Payload: { name, email, phone, temp_password, vio_office, state, lga, state_id, lga_id, capabilities }
 */
...
export const updateAgentCommission = async (agentId, commission_kobo) => {
  return await apiFetch(`/admin/agents/${agentId}/commission`, {
    method: "PATCH",
    body: { commission_kobo },
  });
};

export const bulkUpdateAgentCommission = async (commission_kobo) => {
