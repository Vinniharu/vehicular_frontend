...
/**
 * Get account deletion impact summary (`GET /admin/users/{id}/deletion-summary`).
 */
export async function superAdminGetUserDeletionSummary(id) {
  return apiFetch(`/admin/users/${id}/deletion-summary`, { method: "GET" });
}

/**
 * Permanently delete any account and purge all connected applications (`DELETE /admin/users/{id}`).
 */
