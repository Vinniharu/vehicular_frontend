...
export const SERVICES = [
  ...
  },
  {
    ...
    intro:
      "A full bumper-to-bumper mechanical inspection — a field mechanic visits the vehicle wherever you tell us to meet it, and examines it against a multi-section checklist (exterior & body, engine bay, underbody, interior, and a road test) with photo and video evidence. A senior reviewing mechanic assesses the findings, and Vehiculars staff record the final verdict — recommended to buy, proceed with caution, or not recommended — alongside a full written report. Ideal before a purchase, or for a periodic health check on a vehicle you already own.",
    whatsIncluded: [
      "Exterior & body, engine bay, underbody, interior, and road-test checks",
      "Photo (and video, for the road test) evidence on every item",
      "A senior mechanic's written report on the vehicle's condition",
      "A clear verdict — recommended to buy, proceed with caution, or not recommended",
    ...
    howItWorks: [
      ...
      { title: "Staff review", desc: "Your booking is reviewed, and a field mechanic is sent a no-login link to the vehicle's details over WhatsApp." },
      { title: "Mechanic visits, senior review", desc: "The field mechanic examines the vehicle on site; a senior mechanic reviews the findings by phone or WhatsApp." },
      { title: "Get your verdict and report", desc: "Staff record the final verdict and release your written report as a PDF, with a code you can share to verify it." },
    ],
    children: null,
  },
  {
